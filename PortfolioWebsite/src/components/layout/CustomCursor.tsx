...
export default function CustomCursor() {
    ...
    useEffect(() => {
        ...
        const onMouseDown = () => {
            if (cursor) cursor.style.transform = `translate(${mouseX}px, ${mouseY}px) translate(-50%, -50%) scale(0.8)`;
        };
        const onMouseUp = () => {
            if (cursor) cursor.style.transform = `translate(${mouseX}px, ${mouseY}px) translate(-50%, -50%) scale(1)`;
        };
