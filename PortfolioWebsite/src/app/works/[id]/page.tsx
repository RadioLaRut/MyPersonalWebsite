...
const projectsData: Record<string, any> = {
  "lighting-atmosphere": {
    ...
    col1: {
      ...
      img: "/images/train-station/2Fog.png",
    },
    col2: {
      title: "夜晚",
      text: "光影对比的张力由自发光材质与高光反射驱动。",
      img: "/images/train-station/2Dust.png",
    },
    col3: {
      title: "过程",
      text: "测试了多个 HDRI 贴图结合平行光的渲染管线。",
      img: "/images/city-2026/001.PNG",
    },
    gallery: [
      "/images/train-station/Day.png",
      "/images/train-station/Dusk.png",
      "/images/train-station/Night.png",
      "/images/train-station/NoLight.png",
      "/images/train-station/2Day.png",
      "/images/train-station/2Dust.png",
      "/images/train-station/2Fog.png",
      "/images/train-station/2Night.png",
      "/images/train-station/2NoLight.png",
      "/images/city-2026/001.PNG",
      "/images/city-2026/002.PNG",
      "/images/city-2026/003.PNG",
    ],
  ...
  "slay-the-virus": {
    ...
    idNum: "03",
    heroImage: "/images/slay-the-virus/STVTitle.png",
    description:
    ...
    col1: {
      ...
      img: "/images/slay-the-virus/01.jpg",
    },
    col2: {
      title: "卡牌设计",
      text: "在 Photoshop 中精修由组员绘制的草稿与技能特效资产组合。",
      img: "/images/slay-the-virus/02.jpg",
    },
    col3: {
      title: "后期处理",
      text: "拉升整体视觉的电影感对比度及文字图形的易读性。",
      img: "/images/slay-the-virus/PosterLandscapeOrigine.jpg",
    },
    gallery: ["/images/slay-the-virus/03.jpg", "/images/slay-the-virus/04.jpg", "/images/slay-the-virus/05.jpg"],
  ...
  prometheus: {
    ...
    nextBg: "/images/holy-tank/7d9ca92e5ade09bfc1c349a49001b2eb.png",
  },
  "holy-tank": {
    title: "帅油桶 (HOLY TANK)",
    idNum: "05",
    heroImage: "/images/holy-tank/7d9ca92e5ade09bfc1c349a49001b2eb.png",
    description:
    ...
    col1: {
      ...
      img: "/images/holy-tank/f0f6239817a545ccad2f7dc47aff8acc.png",
    },
    col2: {
      title: "叙事体验",
    ...
    col3: {
      ...
      img: "/images/holy-tank/7d9ca92e5ade09bfc1c349a49001b2eb.png",
    },
    navLink: "https://www.bilibili.com/video/BV1GqkRYxEWM/",
    nextId: "pcg-town",
    nextName: "HOUDINI 驱动生成村镇",
    nextBg: "/images/penguin/PCG/PCG01.png",
  },
  "wow-otto": {
    title: "WOW, OTTO!",
    idNum: "05",
  ...
  "pcg-town": {
    ...
    idNum: "06",
    heroImage: "/images/penguin/PCG/PCG01.png",
    description:
    ...
    col1: {
      ...
      img: "/images/penguin/PCG/PCG02.png",
    },
    col2: {
      title: "样条线路网",
      text: "由任意贝塞尔曲线动态分割计算的智能土路及河流系统。",
      img: "/images/penguin/PCG/PCG03.png",
    },
    col3: {
      title: "环境撒布引擎",
      text: "基于规则的高速碰撞规避算法用于树木与房舍周边杂物的植被生成。",
      img: "/images/penguin/PCG/PCG05.png",
    },
    gallery: ["/images/penguin/PCG/PCG04png.png"],

    nextId: "atmosphere-practice",
    nextName: "ATMOSPHERE PRACTICE",
    nextBg: "/images/penguin/01.png",
  },
  "atmosphere-practice": {
    title: "环境与灯光氛围试炼",
    idNum: "07",
    heroImage: "/images/penguin/01.png",
    description:
    ...
    col1: {
      ...
      img: "/images/penguin/CyberRestaurant.png",
    },
    col2: {
      title: "体积情绪",
      text: "使用厚度极高且带有物理色散的粒子雾系统勾勒极端的空间剪影之美。",
      img: "/images/penguin/02.png",
    },
    col3: {
      title: "破败微距",
      text: "探索贴图与模型瑕疵如何在微妙斜侧光的照耀下获得照片级的张力。",
      img: "/images/penguin/01.png",
    },
    gallery: [
      ...
      "/images/rainforest/Output.0050.png",
      "/images/rainforest/Output.0101.png",
      "/images/rainforest/Shot005.0002.png",
      "/images/rainforest/Version2Output.0029.png",
    ],

    nextId: "epic-stage",
    nextName: "STAGE LIGHTING (EPIC)",
    nextBg: "/images/penguin/Epic.png",
  },
  "epic-stage": {
    title: "舞台灯光叙事概念设计",
    idNum: "08",
    heroImage: "/images/penguin/Epic.png",
    description:
    ...
    col1: {
      ...
      img: "/images/penguin/Epic02.png",
    },
    col2: {
      title: "神座点亮策略",
      text: "后场巨大主神大理石雕塑通过复杂的材质发光指令随着音轨爆破而启动。",
      img: "/images/penguin/Epic.png",
    },
    col3: {
      title: "定格镜头呈现",
    ...
    nextBg: "/images/train-station/2Day.png",
  },
};
